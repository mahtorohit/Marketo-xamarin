...
namespace TestMarketo
{
	...
	public class AppDelegate : UIApplicationDelegate
	{
		...
		public override bool FinishedLaunching(UIApplication application, NSDictionary launchOptions)
		{
			...
			m.InitializeWithMunchkinID("352-XEU-842", "UnAwSXhja216b1Z5Z0EzbEZKMnNXR08x", new NSDictionary());

			MKTSecuritySignature s = new MKTSecuritySignature("dfasda","fadsfads","fs","adsfsad");
