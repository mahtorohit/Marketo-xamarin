...
@implementation AppDelegate { } 
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_7 (self, _cmd, &managed_method, "TestMarketo.AppDelegate, TestMarketo", ".ctor", &call_super);
		if (call_super && rv) {
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [10].handle = objc_getClass ("UILocalNotification");
	...
	__xamarin_class_map [23].handle = objc_getClass ("UIUserNotificationSettings");
	__xamarin_class_map [24].handle = objc_getClass ("UIApplicationShortcutItem");
	...
	__xamarin_class_map [29].handle = [ViewController class];
